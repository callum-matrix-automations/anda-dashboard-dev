import { receiveTranscript } from "../../../../backend/services/transcripts/receiveTranscript";
import {
  TRANSCRIPT_SIGNATURE_HEADER,
  TRANSCRIPT_TIMESTAMP_HEADER,
  verifyTranscriptWebhookSignature,
} from "../../../../backend/integrations/webhooks/transcriptWebhookAuth";
import {
...
export async function POST(request: Request): Promise<Response> {
  ...
  const result = await receiveTranscript(parsed.data);
